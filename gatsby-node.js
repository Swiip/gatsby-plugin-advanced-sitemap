      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            sitemapStylesheet = data.toString().replace(siteRegex, new URL(indexOutput, siteUrl).toString()); // Save the updated stylesheet to the public folder, so it will be
